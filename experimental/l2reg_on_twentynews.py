...
def parse_args():
    ...
    parser.add_argument('--alg', type=str, default='neuman', choices=['minibatch', 'reverse', 'fixed_point', 'CG', 'neuman'])
...
def train_model(args):
    ...
    # x_train = x_train[:,60000:100000]
    # x_val = x_val[:,60000:100000]
    # x_test = x_test[:,60000:100000]
