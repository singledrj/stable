...
def parse_args():
    ...
    parser.add_argument('--n_steps', default=100, type=int, help='epoch numbers')
    ...
    parser.add_argument('--inner_lr', type=float, default=0.02) # beta
...
def train_model(args):
    ...
    file1 = 'musk/clean1.data'
    file2 = 'musk/clean2.data'
    ...
    for line in f1:
        ...
        data.append(datum[2:-1])
        label.append(datum[-1].strip('.'))
    f2 = open(file2,'r')
    for line in f2:
        datum = line.strip().split(',')
        data.append(datum[2:-1])
